...
export const hi: Messages = {
  ...
  email: {
    ...
    signInSubtitle: 'वही ईमेल और पासवर्ड डालें जिससे आपने साइन अप किया था।',
    signUpTitle: 'अकाउंट बनाएँ',
    signUpSubtitle: 'ईमेल बाद में भी कन्फ़र्म कर सकते हैं।',
    emailLabel: 'ईमेल पता',
    ...
    signIn: 'साइन इन करें',
    signUp: 'अकाउंट बनाएँ',
    switchToSignUp: 'नए हैं? अकाउंट बनाएँ',
    switchToSignIn: 'पहले से अकाउंट है? साइन इन करें',
    invalidEmail: 'सही ईमेल पता डालें',
    passwordTooShort: 'कम से कम 8 अक्षर डालें',
    invalidCredentials: 'यह ईमेल या पासवर्ड सही नहीं है',
    taken: 'इस ईमेल से पहले से एक अकाउंट है',

    verifyTitle: 'अपना ईमेल कन्फ़र्म करें',
    verifySubtitle: 'हमने {email} पर 6 अंकों का कोड भेजा है।',
    verifyLater: 'यह बाद में करूँगा',
    verify: 'कन्फ़र्म करें',
    resend: 'नया कोड भेजें',
    verified: 'ईमेल कन्फ़र्म हो गया',
    codeIncorrect: 'यह कोड सही नहीं है',
    codeExpired: 'कोड की समय-सीमा खत्म हो गई। नया कोड भेजें।',
    bannerTitle: 'अपना ईमेल कन्फ़र्म करें',
    bannerBody: 'कॉइन खरीदने से पहले ईमेल या फ़ोन कन्फ़र्म करना ज़रूरी है।',
    bannerAction: 'कन्फ़र्म करें',
  },
